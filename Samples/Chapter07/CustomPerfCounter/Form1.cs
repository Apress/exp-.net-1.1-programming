...
namespace Apress.ExpertDotNet.CustomPerfCounter
{
	/// <summary>
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.TextBox tbCommittedBytes;
		private System.ComponentModel.IContainer components;
		private System.Windows.Forms.Timer timer;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.TextBox tbMegaByteAllocs;

		PerformanceCounter pcGen0Collections;
		PerformanceCounter pcCommittedBytes;
		PerformanceCounter pcMegaByteAllocs;

		string categoryName = "ExpertDotNet";
		string counterName  = "# MegaByteClasses created";
		string categoryHelp = "Advanced .NET Sample Counters";
		string counterHelp = "Counts total MegaByteClass allocations";
		string instanceName = "CustomPerfCtr";
		...
		public Form1()
		{
			...
			this.pcGen0Collections = new PerformanceCounter(".NET CLR Memory",
				"# Gen 0 Collections", "CustomPerfCount");
			this.pcGen0Collections.BeginInit();
			this.pcCommittedBytes = new PerformanceCounter(".NET CLR Memory",
				"# Gen 1 Collections", "CustomPerfCount");
			this.pcCommittedBytes.BeginInit();

			RegisterCustomCounter();

			this.label1.Text = this.pcGen0Collections.CounterName;
			this.label2.Text = this.pcCommittedBytes.CounterName;
			this.label3.Text = this.pcMegaByteAllocs.CounterName;
		...
		{	
			...
			this.pcMegaByteAllocs.RawValue += 1;
		}
		...
		private void InitializeComponent()
		{
			...
			this.tbCommittedBytes = new System.Windows.Forms.TextBox();
			this.tbGen0Collections = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.timer = new System.Windows.Forms.Timer(this.components);
			this.label3 = new System.Windows.Forms.Label();
			this.tbMegaByteAllocs = new System.Windows.Forms.TextBox();
			...
			this.groupBox3.Controls.AddRange(new System.Windows.Forms.Control[] {
																					this.tbMegaByteAllocs,
																					this.label3,
																					this.tbCommittedBytes,
			...
			// tbCommittedBytes
			// 
			this.tbCommittedBytes.Location = new System.Drawing.Point(160, 40);
			this.tbCommittedBytes.Name = "tbCommittedBytes";
			this.tbCommittedBytes.ReadOnly = true;
			this.tbCommittedBytes.Size = new System.Drawing.Size(104, 20);
			this.tbCommittedBytes.TabIndex = 3;
			this.tbCommittedBytes.Text = "";
			// 
			// tbGen0Collections
			// 
			...
			// tbMegaByteAllocs
			// 
			this.tbMegaByteAllocs.Location = new System.Drawing.Point(160, 64);
			this.tbMegaByteAllocs.Name = "tbMegaByteAllocs";
			this.tbMegaByteAllocs.ReadOnly = true;
			this.tbMegaByteAllocs.Size = new System.Drawing.Size(104, 20);
			this.tbMegaByteAllocs.TabIndex = 5;
			this.tbMegaByteAllocs.Text = "";
			// 
			// Form1
			// 
		...
		private void timer_Tick(object sender, System.EventArgs e)
		{
			...
			this.tbCommittedBytes.Text = this.pcCommittedBytes.NextValue().ToString();
			this.tbMegaByteAllocs.Text = this.pcMegaByteAllocs.RawValue.ToString();
		}


		private void RegisterCustomCounter()
		{
			if(!PerformanceCounterCategory.Exists(categoryName))
			{
				PerformanceCounterCategory.Create(categoryName,categoryHelp,counterName,counterHelp);
			}
			pcMegaByteAllocs = new PerformanceCounter(categoryName, counterName ,instanceName, false);
			pcMegaByteAllocs.RawValue = 0;
		}

		private void DeregisterCounter()
		{
			if (PerformanceCounterCategory.Exists(categoryName))
